...
class TableConstants {
  ...
  /// 默认保留高度
  static const double defaultReservedHeight = 100.0;
  
  /// 紧凑模式保留高度
  static const double compactReservedHeight = 80.0;
  
  /// 大表格模式保留高度
  static const double largeReservedHeight = 120.0;
}
...
class ApprovalConstants {
  ...
  static const List<double> defaultColumnWidths = [
    0.10, // 排序 - 10%
    0.18, // 节点名称 - 18%
    0.18, // 审批人 - 18%
    0.18, // 签名 - 18%
